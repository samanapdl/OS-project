...
public class ActivityPriority extends AppCompatActivity {
    ...
    public static void main(String[] args) {
        ...
        Priorityclass f1 = new Priorityclass();
        Thread scheduler = new Thread(f1);
        scheduler.start();
    }
}
class Priorityclass implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(Priorityclass.class.getName()).log(Level.SEVERE, null, ex);
            }
            int n = 0;
